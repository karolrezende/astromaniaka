            ...
            <div className="flex flex-col gap-3 md:w-[30rem]">
                ...
                <section className="flex flex-col gap-3">
                    <div className="flex flex-col">
                        <textarea className="rounded-xl text-center flex items-center resize-none placeholder:text-md placeholder:font-medium outline-none" placeholder="Título"/>
                        <textarea
                            ref={inputRef}
                            value={text}
                            onChange={handleTextChange}
                            className="pb-4 rounded-xl resize-none placeholder:text-base outline-none"
